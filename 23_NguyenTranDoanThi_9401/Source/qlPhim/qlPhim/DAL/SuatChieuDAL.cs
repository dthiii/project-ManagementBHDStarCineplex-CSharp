...
namespace qlPhim.DAL
{
    public class SuatChieuDAL
    {
        ...
        public SuatChieuDAL(string maSC, string maPhong, string tenPhong, string maPhim, string tenPhim, int thoiLuong, DateTime thoiGianBD, int soGheTrong, int tongSoGhe)
        {
            this.maSC = maSC;
        ...
        public SuatChieuDAL(DataRow row)
        {
