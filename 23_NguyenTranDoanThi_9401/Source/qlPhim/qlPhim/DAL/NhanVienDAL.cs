...
namespace qlPhim.DAL
{
    public class NhanVienDAL
    {
        ...
        public NhanVienDAL(string maNV, string hoNV, string tenNV, DateTime ngaySinh, string gioiTinh, DateTime ngayVaoLam, string maCV, string dienThoai, string email, string matKhau, string diaChi)
        {
            this.maNV = maNV;
            this.hoNV = hoNV;
            this.tenNV = tenNV;
        ...
        public NhanVienDAL(DataRow row)
        {
