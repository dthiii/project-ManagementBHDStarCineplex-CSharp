...
namespace qlPhim.DAL
{
    public class KhachHangDAL
    {
        ...
        public KhachHangDAL(string maKH, string hoKH, string tenKH, DateTime ngaySinh, string gioiTinh, DateTime ngayDangKy, int diemTichLuy, string maBacTV, string dienThoai, string email, string diaChi)
        {
            this.maKH = maKH;
            this.hoKH = hoKH;
            this.tenKH = tenKH;
        ...
        public KhachHangDAL(DataRow row)
        {
