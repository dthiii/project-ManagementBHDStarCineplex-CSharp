...
namespace qlPhim.DAL
{
    public class TinhTrangGheDAL
    {
        ...
        public TinhTrangGheDAL(string maSC, string maGhe, string tinhTrang, string maLoaiGhe, double giaGhe)
        {
            this.maSC = maSC;
            this.maGhe = maGhe;
        ...
        public TinhTrangGheDAL(DataRow row)
        {
