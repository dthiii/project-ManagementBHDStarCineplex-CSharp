...
namespace qlPhim.DAL
{
    public class ChiTietPhimDAL
    {
        ...
        public ChiTietPhimDAL(string maPhim, string tenPhim, string maPL, byte[] bieuTuongPL, string daoDien, string quocGia, int thoiLuong, DateTime ngayKhoiChieu, string moTa, byte[] poster, string trailer, string theLoaiPhim)
        {
            this.maPhim = maPhim;
        ...
        public ChiTietPhimDAL(DataRow row)
        {
